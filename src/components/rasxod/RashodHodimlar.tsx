		...
		<div className="bg-[#fff] mt-[20px]">
			...
			<div className="flex items-center justify-between px-5">
				<div className="flex items-center gap-6">
					<Select
						showSearch
						style={{ width: 250, marginTop: '11px' }}
				...
				<div className="flex items-center gap-[31px]">
					<div className="bg-[#DFE8F1] flex p-4 h-[30px] border border-[#00000014] rounded-[5px] items-center gap-1 mt-4">
						<input
							type="text"
							className="border-0 outline-none bg-transparent"
							placeholder="Search"
			...
			<div className="border mt-[20px]">
				<div className="bg-[#4D5773] w-full flex gap-[30px] items-center p-[10px] text-[#fff] rounded-tl-[5px] rounded-tr-[5px]">
					...
					<div className="grid grid-cols-10 items-center gap-2 w-full">
						...
						<h2 className="text-[14px] font-semibold -ml-[120px]">
							Kirituvchi shaxs
						</h2>
						<h3 className="text-[14px] font-semibold -ml-[100px]">
							Rashod Bolimi
						</h3>
						<h3 className="text-[14px] font-semibold -ml-[90px]">
							Rashod Turi
						</h3>
